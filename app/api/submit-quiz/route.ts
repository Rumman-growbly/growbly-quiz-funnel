  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#09090f;padding:40px 16px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
        ...
        <!-- Main card -->
        <tr>
          <td style="background:#13111f;border-radius:20px;overflow:hidden;border:1px solid #1f1b35;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding:28px 40px 0;">
                  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d0b1a;border-radius:12px;padding:20px;">
                    <tr>
            ...
            <!-- Divider -->
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:28px 40px 0;"><div style="height:1px;background:#1f1b35;"></div></td></tr>
            </table>
