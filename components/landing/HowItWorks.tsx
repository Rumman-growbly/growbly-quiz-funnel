const steps = [
  ...
  {
    number: "02",
    title: "We find your biggest operational gap",
    description:
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 items-stretch">
          {steps.map((step, i) => (
            <div key={i} className="relative h-full">
              ...
              <div className="relative z-10 p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:border-gray-200 transition-colors h-full flex flex-col">
